    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="bg-white rounded-2xl shadow-sm border border-gray-200/60 p-8">
        <div class="text-center mb-8">
          ...
          <p class="text-gray-600">Guide to setting up your family space</p>
        </div>

        <div class="prose prose-lg max-w-none">
          <p class="text-gray-600 text-center">
            Detailed guide coming soon. This page will contain step-by-step
            instructions for creating your first family.
          </p>
          ...
          <div class="mt-8 p-6 bg-green-50 rounded-xl border border-green-200">
            <div class="flex items-center gap-3">
              ...
              <div>
                <h3 class="font-semibold text-green-900">What You'll Need</h3>
                <p class="text-green-700 text-sm mt-1">
                  • A completed user profile<br />
                  • A unique family name<br />
                  • Basic information about your family members<br />
                  • Understanding of family roles (parent/member)
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="mt-8 flex justify-center">
          <NuxtLink
            to="/help"
            class="inline-flex items-center gap-2 px-6 py-3 bg-green-600 text-white font-semibold rounded-xl hover:bg-green-700 transition-colors"
          >
...
<script setup>
useHead({
  title: "Creating First Family - FamilySpace Guides",
});
</script>
