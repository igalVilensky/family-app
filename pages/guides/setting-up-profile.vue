    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="bg-white rounded-2xl shadow-sm border border-gray-200/60 p-8">
        <div class="text-center mb-8">
          ...
          <p class="text-gray-600">Complete your FamilySpace profile</p>
        </div>

        <div class="prose prose-lg max-w-none">
          <p class="text-gray-600 text-center">
            Profile setup guide is under development.
          </p>
          ...
          <div class="mt-8 p-6 bg-amber-50 rounded-xl border border-amber-200">
            <div class="flex items-center gap-3">
              ...
              <div>
                <h3 class="font-semibold text-amber-900">Profile Essentials</h3>
                <p class="text-amber-700 text-sm mt-1">
                  • Add your profile photo<br />
                  • Set your display name<br />
                  • Choose your family role<br />
...
<script setup>
useHead({
  title: "Profile Setup - FamilySpace Guides",
});
</script>
