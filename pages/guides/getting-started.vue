    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="bg-white rounded-2xl shadow-sm border border-gray-200/60 p-8">
        <div class="text-center mb-8">
          ...
          <p class="text-gray-600">Learn the basics of FamilySpace</p>
        </div>

        <div class="prose prose-lg max-w-none">
          <p class="text-gray-600 text-center">
            This guide is currently being prepared. Check back soon for detailed
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-blue-700 text-sm mt-1">
                  • Set up your profile completely<br />
                  • Create or join a family<br />
...
<script setup>
useHead({
  title: "Getting Started - FamilySpace Guides",
});
</script>
