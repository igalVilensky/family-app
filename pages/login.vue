<template>
  <div
    class="min-h-screen bg-gradient-to-br from-orange-50 via-rose-50 to-purple-50 dark:from-stone-900 dark:via-stone-800 dark:to-stone-900 pb-4 transition-colors duration-300">
    <!-- Main Content -->
    <main class="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-8 md:py-12">
      <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
          ...
          <h2 class="text-4xl font-bold text-gray-900 dark:text-white mb-3">
            Welcome
            <span
              class="bg-gradient-to-r from-orange-600 via-rose-600 to-purple-600 bg-clip-text text-transparent">Back</span>
          </h2>
        ...
        <!-- Login Form -->
        <div
          class="bg-white/90 dark:bg-stone-800/90 backdrop-blur-sm rounded-3xl shadow-xl border-2 border-orange-200 dark:border-stone-700 p-8 transition-colors">
          <form @submit.prevent="handleLogin" class="space-y-6">
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input type="email" id="email" v-model="email"
                  class="w-full pl-12 pr-4 py-4 border-2 border-gray-200 dark:border-stone-600 rounded-2xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 bg-white dark:bg-stone-700 hover:border-orange-300 dark:hover:border-stone-500"
            ...
            <div>
              ...
              <div class="relative">
                ...
                <button type="button" @click="showPassword = !showPassword"
                  ...
                  :disabled="loading">
                  <i class="text-lg" :class="showPassword ? 'fas fa-eye-slash' : 'fas fa-eye'"></i>
                </button>
              </div>
            </div>
            ...
            <button type="submit"
              ...
              <span class="text-lg">{{ loading ? "Signing You In..." : "Sign In to FamilySpace" }}</span>
            </button>
          </form>
          ...
          <div class="relative my-8">
            <div class="absolute inset-0 flex items-center">
              <div class="w-full border-t border-gray-200 dark:border-stone-600"></div>
            </div>
            <div class="relative flex justify-center text-sm">
              <span class="px-4 bg-white dark:bg-stone-800 text-gray-500 dark:text-gray-400 font-medium">New to our
                family?</span>
            </div>
          </div>
          ...
          <NuxtLink to="/register"
            class="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white dark:bg-stone-700 border-2 border-gray-200 dark:border-stone-600 text-gray-700 dark:text-white font-bold rounded-2xl hover:border-orange-500 hover:text-orange-600 hover:bg-orange-50 dark:hover:bg-stone-600 transition-all duration-200 transform hover:-translate-y-1 shadow-md">
        ...
        <div class="grid grid-cols-3 gap-4 text-center">
          <div
            class="bg-white/80 dark:bg-stone-800/80 backdrop-blur-sm rounded-2xl shadow-sm border-2 border-green-100 dark:border-green-900/30 p-4">
            <i class="fas fa-shield-alt text-green-500 text-lg mb-2"></i>
            <p class="text-xs font-medium text-gray-700 dark:text-gray-300">Secure Login</p>
          </div>
          <div
            class="bg-white/80 dark:bg-stone-800/80 backdrop-blur-sm rounded-2xl shadow-sm border-2 border-blue-100 dark:border-blue-900/30 p-4">
            <i class="fas fa-lock text-blue-500 text-lg mb-2"></i>
            <p class="text-xs font-medium text-gray-700 dark:text-gray-300">Encrypted</p>
          </div>
          <div
            class="bg-white/80 dark:bg-stone-800/80 backdrop-blur-sm rounded-2xl shadow-sm border-2 border-purple-100 dark:border-purple-900/30 p-4">
            <i class="fas fa-users text-purple-500 text-lg mb-2"></i>
            <p class="text-xs font-medium text-gray-700 dark:text-gray-300">Family-First</p>
          </div>
        </div>

        <!-- Demo Account Info -->
        <div
          class="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-2 border-amber-300 dark:border-amber-700 rounded-3xl p-6 text-center">
          <div class="flex items-center justify-center gap-2 mb-3">
            <i class="fas fa-sparkles text-amber-600 dark:text-amber-400 text-lg"></i>
            <h4 class="font-bold text-amber-900 dark:text-amber-100">Try Demo Account</h4>
          </div>
          <p class="text-amber-700 dark:text-amber-200 text-sm mb-4 font-medium">
            Explore FamilySpace with our demo account to see all features in action.
          </p>
    ...
    <!-- Footer -->
    <footer
      class="bg-white/90 dark:bg-stone-800/90 backdrop-blur-sm rounded-3xl shadow-lg border-2 border-gray-200 dark:border-stone-700 p-8 mx-4">
      <div class="text-center">
        ...
        <p class="text-gray-600 dark:text-gray-400 font-medium">
          Made with <i class="fas fa-heart text-rose-500"></i> for families everywhere
        </p>
      </div>
    </footer>
  </div>
